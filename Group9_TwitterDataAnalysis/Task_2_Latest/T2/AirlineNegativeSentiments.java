...
//      Path inPath = new Path("hdfs://ec2-54-169-135-58.ap-southeast-1.compute.amazonaws.com:8020/user/phamvanvung/airline/input");
//      Path outPath = new Path("hdfs://ec2-54-169-135-58.ap-southeast-1.compute.amazonaws.com:8020/user/phamvanvung/airline/output");
        ...
        ChainMapper.addMapper(job, ANSMapper.class, LongWritable.class, Text.class, Text.class, IntWritable.class, ansConf);        
